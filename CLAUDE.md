...
```powershell
Remove-Item "installer\Output\OverallDashboardSetup_1.2.1.exe" -Force -ErrorAction SilentlyContinue
& "C:\Program Files (x86)\Inno Setup 6\ISCC.exe" "installer\setup.iss"
```
Output: `installer\Output\OverallDashboardSetup_1.2.1.exe`
...
1. Copy `installer\Output\OverallDashboardSetup_1.2.1.exe` to the target machine
